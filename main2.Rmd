...
linear_model2 <- lm(BMXWT ~ SMQ040 + RIAGENDR + FIAINTRP + RIDAGEYR + ALQ130 + RIDRETH1:SMQ040 + RIDRETH1:FIAINTRP + SMQ040:RIAGENDR + RIAGENDR:FIAINTRP, data=data2)
...
linear_model3 <- lm(BMXWT ~ SMQ040 + RIAGENDR + FIAINTRP + RIDAGEYR + ALQ130 + RIDRETH1:SMQ040 + RIDRETH1:FIAINTRP + SMQ040:RIAGENDR + RIAGENDR:FIAINTRP, data=data3)
stepwise3 <- step(linear_model3, direction = "both")
...
linear_model4 <- lm(BMXWT ~ SMQ040 + RIAGENDR + FIAINTRP + RIDAGEYR + ALQ130 + RIDRETH1:SMQ040 + RIDRETH1:FIAINTRP + SMQ040:RIAGENDR + RIAGENDR:FIAINTRP, data=data4)
stepwise4 <- step(linear_model4, direction = "both")
...
linear_model_log <- lm(log(BMXWT) ~ SMQ040 + RIAGENDR + FIAINTRP + RIDAGEYR + ALQ130 + RIDRETH1:SMQ040 + RIDRETH1:FIAINTRP + SMQ040:RIAGENDR + RIAGENDR:FIAINTRP, data=data5)
stepwise_log <- step(linear_model_log, direction = "both")
